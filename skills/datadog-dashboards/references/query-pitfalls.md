...
**Fix:** promote the handful of KPIs worth long-term trending to log-based metrics. **Never tag a metric with high-cardinality fields** (scan_token, execution_id, pentest_token, user_id). Safe group-by tags: tool, status, reason, jobs_status, env.
