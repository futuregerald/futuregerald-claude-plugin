...
State this wherever a per-engineer number appears — in the report, and in the HTML page's method
...
- **Re-derive the critical chain with the split applied** (the ordering in `method.md` Phase 6). A split that
