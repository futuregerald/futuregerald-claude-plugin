...
description: Explore a codebase to find opportunities for architectural improvement, focusing on making the codebase more testable by deepening shallow modules. Use when user wants to improve architecture, find refactoring opportunities, consolidate tightly-coupled modules, or make a codebase more AI-navigable. Supports both GitHub Issues and Jira.
...
Create a refactor RFC as an issue in the project's configured issue tracker. Do NOT ask the user to review before creating — just create it and share the URL.

**Issue tracker detection:**
- Check CLAUDE.md for ticket system configuration (e.g., `### Ticket Grooming` section or Jira project key)
- If Jira is configured: create via `createJiraIssue` (Atlassian MCP) with issue type "Task", the `claude-code` label, and `contentFormat: "markdown"` for the description
